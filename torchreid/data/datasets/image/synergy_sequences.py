...
class SynergySequences(ImageDataset):
    ...
    def __init__(self, root='', masks_dir=None, **kwargs):
        ...
        self.train_dir = osp.join(self.data_dir, self.images_dir, 'bbox_train_full')
        self.query_dir = osp.join(self.data_dir, self.images_dir, 'bbox_val_full')
        self.gallery_dir = osp.join(self.data_dir, self.images_dir, 'bbox_val_full')
